...
const AMENITIES = [
  ...
  { icon: Mountain, label: "Área para camping" },
  { icon: WifiOff, label: "Desconexão digital" },
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            <p className="text-lg leading-relaxed text-[#6b7c6b]">
              O Recanto Aconchego é a escolha perfeita para quem busca uma
              experiência autêntica em contato com a natureza. Localizado
              proximo ao rio, o espaço oferece um ambiente simples, rústico e
              acolhedor, ideal para famílias e amigos.
            </p>
            <p className="mt-4 text-lg leading-relaxed text-[#6b7c6b]">
              Além do chalé para duas pessoas, o recanto conta com uma ampla
              área externa com churrasqueira, fogueira, campo de vôlei, rede
              suspensa e espaço para acampamento. Uma verdadeira experiência de
              glamping no interior de Santa Catarina.
            </p>
            ...
            <div className="mt-10 flex gap-12 border-t border-[#d4cfc5] pt-10">
              <div>
                ...
                <p className="mt-1 text-sm text-[#6b7c6b]">acesso direto</p>
              </div>
              <div>
                <span className="font-serif text-3xl font-medium text-[#2d3a2e]">
                  10+
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-[#6b7c6b]">na área de festas</p>
              </div>
            </div>
          </div>
        </div>
