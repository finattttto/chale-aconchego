...
const ACTIVITIES = [
  {
    icon: Droplets,
    title: "Rio",
    description: "Banho e diversão nas águas calmas",
  },
  {
    icon: Trophy,
    title: "Vôlei",
    description: "Partidas no campo de vôlei",
  },
  {
    icon: Mountain,
    title: "Camping",
    description: "Área para montar sua barraca",
  },
  {
    icon: Flame,
    title: "Fogueira",
    description: "Noites memoráveis ao ar livre",
  },
  {
    icon: Users,
    title: "Área de festas",
    description: "Espaço para grandes reuniões",
  },
  {
    icon: Trees,
    title: "Trilhas",
