...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    text: "Passamos nosso aniversario de casamento e foi perfeito. A vista do por do sol e de tirar o folego. Ambiente super romantico!",
    rating: 5,
  },
  {
    name: "Beatriz e Thiago",
    location: "Joinville, SC",
    text: "Ja e a terceira vez que voltamos. Nao cansamos de nos encantar com a tranquilidade e beleza do lugar. Viramos fas!",
    rating: 5,
  },
  {
    name: "Mariana e Diego",
    location: "Blumenau, SC",
    text: "Melhor escolha para um final de semana romantico. Silencio absoluto, natureza exuberante e muito conforto. Perfeito!",
    rating: 5,
  },
  {
    name: "Patricia e Bruno",
    location: "Chapeco, SC",
    text: "Superou todas as expectativas! A estrutura e impecavel e os anfitrioes sao muito atenciosos. Voltaremos em breve.",
    rating: 5,
  },
  {
    name: "Carolina e Gustavo",
    location: "Criciuma, SC",
    text: "Um verdadeiro refugio! Acordar com o canto dos passaros e tomar cafe com aquela vista foi inesquecivel.",
    rating: 5,
  },
];
