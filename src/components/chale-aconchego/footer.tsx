    ...
    <footer id="contato" className="bg-primary text-primary-foreground">
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
          {/* Brand */}
          <div>
            <h3 className="font-serif text-2xl font-medium">Chalé Aconchego</h3>
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-primary-foreground/70">
              Onde cada detalhe é sinônimo de conforto e tranquilidade em conexão
              com a natureza.
            </p>
            <div className="mt-6">
              <Link
              ...
              >
                Conheça também o Recanto Aconchego
              </Link>
            </div>
          </div>
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="mt-4 overflow-hidden rounded-sm">
              <iframe
                ...
                title="Localização do Chalé Aconchego no Google Maps"
              />
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="mx-auto flex max-w-7xl items-center justify-center px-6 py-5 lg:px-8">
          <p className="text-xs text-primary-foreground/40">
            &copy; {new Date().getFullYear()} Chalé Aconchego. Todos os
            direitos reservados.
          </p>
        </div>
      </div>
