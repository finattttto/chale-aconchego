...
const HIGHLIGHTS = [
  {
    ...
    description:
      "Relaxe na banheira de hidromassagem.",
  },
  {
    icon: Flame,
  ...
  {
    icon: Sun,
    title: "Pôr do sol deslumbrante",
    description:
      "Contemple o espetaculo do pôr do sol direto da varanda do chalé.",
  },
  {
    icon: Coffee,
    title: "Café da manhã colonial",
    description:
      "Opção de café da manhã com produtos coloniais frescos da região.",
  },
];
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="relative aspect-[3/4] overflow-hidden rounded-sm">
              <Image
                ...
                alt="Banheira do Chalé Aconchego"
                fill
            ...
            <div className="relative mt-8 aspect-[3/4] overflow-hidden rounded-sm">
              <Image
                ...
                alt="Fogueira do Chalé Aconchego"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 50vw, 25vw"
                quality={70}
